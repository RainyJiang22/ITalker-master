...
import net.jacky.italker.common.app.ToolbarActivity;
import net.jacky.italker.push.R;
import net.jacky.italker.push.frags.search.SearchGroupFragment;
import net.jacky.italker.push.frags.search.SearchUserFragment;
